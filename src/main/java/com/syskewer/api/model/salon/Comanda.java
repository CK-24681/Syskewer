...
@Entity
@jakarta.persistence.Table(name = "tb_comanda")
public class Comanda extends BaseEntity<Integer> {
    ...
    private ComandaStatus status = ComandaStatus.OPEN;
